...
namespace Caffe.Business.Component
{
    class E_tb_Nhanvien
    {
        ...
        public void loadInfor(TextBox manv,TextBox TenNV, DateTimePicker dateTime, ComboBox cbGT,ComboBox cbque, TextBox que, TextBox sdt,TextBox diachi, string tennv)
        {
            nvsql.loadProfileNV(manv,TenNV,dateTime,cbGT,cbque,que,sdt,diachi,tennv);
        }
    }
}
