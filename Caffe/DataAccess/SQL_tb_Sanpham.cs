    ...
    class SQL_tb_Sanpham
    {
        ...
        public void themmoiHang(EC_tb_Sanpham hang)
        {
            ...
            try
            {
                ...
                con.Open();
                string sql = @"INSERT INTO tb_Sanpham  (masp, tensp, maloai, gianhap, giaban, soluong) VALUES (N'" + hang.MASP + "',N'" + hang.TENSP + "',N'" + hang.MALOAI + "',N'" + hang.GIANHAP + "',N'" + hang.GIABAN + "',N'" + hang.SOLUONG + "')";
        ...
        public void suaHang(EC_tb_Sanpham hang)
        {
            ...
            try
            {
                ...
                SET  tensp =N'" + hang.TENSP + "', maloai =N'" + hang.MALOAI + "', giaban =N'" + hang.GIABAN + "', soluong =N'" + hang.SOLUONG + "' where masp=N'" + hang.MASP + "'";
                SqlCommand cmd = new SqlCommand(sql, con);
                cmd.ExecuteNonQuery();
            }
            catch (Exception ex)
