...
namespace Caffe.Presentation
{
    public partial class fr_CTHDN : Form
    {
        ...
        public void hienthi()
        {
            string sql = "SELECT mahdn, masp, soluong, dongia, khuyenmai, thanhtien FROM tb_CTHDN where mahdn=N'"+sohdn+"'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            sql = @"SELECT  tb_CTHDN.mahdn, tb_NCC.tenncc, tb_NCC.diachi, tb_NCC.sdt, tb_Nhanvien.tennv,tb_HDN.ngaynhap,tb_CTHDN.thanhtien
...
FROM         tb_CTHDN INNER JOIN
            ...
            exRange.Font.Bold = true;
            exRange.Value2 = tblThongtinHD.Rows[0][6].ToString();
