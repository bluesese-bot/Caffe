...
{
    public partial class fr_BC_Quy_HDN : Form
    {
        public fr_BC_Quy_HDN()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            sql = @"SELECT  top(5)   mahdn, tongtien FROM  tb_HDN where tb_HDN.ngaynhap BETWEEN '" + d1.Text + "' AND '" + d2.Text + "' order by tongtien DESC";
        ...
        private void fr_BC_Quy_HDN_Load(object sender, EventArgs e)
        {
